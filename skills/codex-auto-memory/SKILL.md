...
1. 读取 `~/.codex/codex-product-manager-role-pack.json`，确认知识库路径和检索上限。
...
7. 个人候选写入 `06-Growth/个人目录/岗位/姓名/`；岗位与公共资产只生成候选，不自动晋升。
...
8. 验证产品主岗位、三个支持岗位、共享五角色和 `five-role-deliberation` Skill 均已安装。

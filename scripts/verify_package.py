...
REQUIRED = [
    ...
    "skills/product-ui-design-baseline/SKILL.md",
    "skills/product-ui-design-baseline/references/ui-visual-design-baseline.md",
    "agents/coordinator.toml",
    "agents/product-manager-specialist.toml",
    "agents/ui-designer-specialist.toml",
    "agents/ai-agent-architect-specialist.toml",
    "agents/director-specialist.toml",
    ...
    "assets/knowledge-base/04-Methods/产品UI设计基线.md",
    ...
    "docs/RELEASE-0.5.0-beta.1.md",
    "knowledge/README.md",
    "knowledge/templates/knowledge-object.md",
    "evaluations/product-manager.jsonl",
    "evaluations/role-routing.jsonl",
    "evaluations/behavior-memory.jsonl",
    "knowledge/roles/product-manager/approved/behavior-memory.md",
    "PUBLIC-SOURCES.json",
    "skills/REGISTRY.json",
    "skills/product-manager-core/references/knowledge-governance.md",
    "skills/product-manager-core/references/role-routing.md",
]
...
def main() -> int:
    ...
    routing_text = (root / "assets" / "templates" / "global-agents-block.md").read_text(encoding="utf-8")
    routing_ok = all(
        token in routing_text
        for token in ("TASK_JUDGE", "CONTROL_DIRECT", "JOB_SPECIALIST", "DOMAIN_PANEL", "SUPPORT_REQUEST")
    )
    checks.append({"check": "central_product_role_routing", "ok": routing_ok})
